  ...
  render() {
    ...
    return (
      <div>
        ...
        <section>
          <Btn show={!running && !end} onClick={start}>
            Start
          </Btn>
          <Btn show={running} onClick={pause}>
            Pause
          </Btn>
          <Btn show={running} onClick={stop}>
            Stop
          </Btn>
          <Btn show={end} onClick={reset}>
            Reset
          </Btn>
        </section>
      </div>
...
export default connect(mapStateToPropsFactory, mapDispatchToPropsFactory)(Watch)
